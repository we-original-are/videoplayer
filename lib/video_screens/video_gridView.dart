...
class VidGridView extends StatefulWidget {
  const VidGridView(
  ...
  @override
  _VidGridViewState createState() => _VidGridViewState();
}

class _VidGridViewState extends State<VidGridView> {
      ...
      body: Scrollbar(
        child: GridView.count(
          ...
          children: List.generate(widget.videosInfo.length, (index) {
            ...
            return _videoGridView(index, control);
          }),
        ),
      ),
    );
  ...
  _videoGridView(int index, VideoPlayerController control) {
